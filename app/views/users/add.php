...
<div class="form-container">
    ...
    <form action="<?php echo BASE_URL; ?>/users/add" method="post">
        ...
        <div class="form-group">
            ...
            <?php if (!empty($data['errors']['password'])): ?><div class="error"><?php echo $data['errors']['password']; ?></div><?php endif; ?>
        </div>
        <div class="form-group">
            <label for="confirm_password">Confirmar Contraseña</label>
            <input type="password" id="confirm_password" name="confirm_password">
            <?php if (!empty($data['errors']['confirm_password'])): ?><div class="error"><?php echo $data['errors']['confirm_password']; ?></div><?php endif; ?>
        </div>
        <div class="form-group">
