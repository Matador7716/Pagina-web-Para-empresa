        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="page-inicio.php#experiencias">EXPERIENCIAS</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row g-4 justify-content-between">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="page-inicio.php#experiencias"><i class="bi bi-chevron-right text-warning fs-6"></i> EXPERIENCIAS</a></li>
