...
<head>
    ...
    <style>
        ...
        .top-header .left-section span { display: flex; align-items: center; gap: 8px; }
        ...
        @media (max-width: 768px) {
            ...
            .packages-grid, .footer-grid { grid-template-columns: 1fr; }
    ...
    <header>
        <div class="top-header">
            <div class="left-section">
                <span><i class="fas fa-credit-card"></i> Formas de Pago</span>
                <span><i class="fab fa-cc-visa"></i> Pagos Online</span>
            </div>
        ...
        <section class="about-section">
            ...
            <div class="about-carousel">
                <div class="swiper-container about-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" style="background-image:url('http://localhost/Agenccia%20de%20turismo%20-%20%20cusco/wp-content/uploads/2025/11/laguna-humantay-4.jpg')"></div>
                        <div class="swiper-slide" style="background-image:url('http://localhost/Agenccia%20de%20turismo%20-%20%20cusco/wp-content/uploads/2025/11/laguna-humantay-5.jpg')"></div>
                        <div class="swiper-slide" style="background-image:url('http://localhost/Agenccia%20de%20turismo%20-%20%20cusco/wp-content/uploads/2025/11/Machupicchu-Cusco-1.jpg')"></div>
                        <div class="swiper-slide" style="background-image:url('http://localhost/Agenccia%20de%20turismo%20-%20%20cusco/wp-content/uploads/2025/11/Machupicchu-Cusco-2.jpg')"></div>
                        <div class="swiper-slide" style="background-image:url('http://localhost/Agenccia%20de%20turismo%20-%20%20cusco/wp-content/uploads/2025/11/Machupicchu-Cusco-3.jpg')"></div>
                    </div>
    ...
    <footer class="main-footer">
        <div class="footer-grid">
            <div class="footer-col">
                <img src="http://localhost/Agenccia%20de%20turismo%20-%20%20cusco/wp-content/uploads/2025/11/Logo-RA-Travel-Cusco.png" alt="RA Travel Logo" style="margin-bottom: 20px; background: #fff; padding: 5px; border-radius: 5px;">
